...
public class ListViewAdapter extends BaseAdapter {
    ...
    // return number of data using adapter
    @Override
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RadioButton selectedRadioButton = (RadioButton) convertView.findViewById(R.id.btnradio);
        ImageView appImageView = (ImageView) convertView.findViewById(R.id.imageitem);
        TextView appTextView = (TextView) convertView.findViewById(R.id.textitem);
    ...
    */
    ...
    public void addItem(boolean aSelected, String aAppImage, String aAppName) {
        ...
        item.setAppImage(aAppImage);
        item.setAppName(aAppName);
